...
import com.sjw.vo.ProblemCacheVo;
import com.sjw.vo.ProblemDBVo;
...
public class ProblemMultiService {
    ...
    //存放处理过题目内容的缓存
    private static ConcurrentHashMap<Integer,ProblemCacheVo> problemCache = new ConcurrentHashMap<>();

    //存放正在处理的题目的缓存，防止多个线程同时处理一个题目
    private static ConcurrentHashMap<Integer,Future<ProblemCacheVo>> processingProblemCache = new ConcurrentHashMap<>();
